...
Multiple qualifiers can be combined on a single value. When a description was generated by an LLM, add **P1642** (`generated by`, item QID) as a second qualifier:
```json
"P983": [
  {"value": "y_n", "qualifiers": {"P1962": "output sequence value at step n", "P1642": "Q7266517"}},
  {"value": "u_n", "qualifiers": {"P1962": "control input at step n",          "P1642": "Q7266517"}}
]
```
