...
cat > /tmp/formula.json << 'ENDJSON'
{
  ...
  "claims": {
    ...
    "P983": [
      {"value": "\\zeta", "qualifiers": {"P1962": "Riemann zeta function", "P1642": "Q7266517"}},
      {"value": "s",      "qualifiers": {"P1962": "complex variable",       "P1642": "Q7266517"}}
    ],
...
| generated by | P1642 | item (QID) | mark the description as AI-generated; use `Q7266517` for Claude Sonnet 4.6 |
